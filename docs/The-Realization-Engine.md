...
The program's work has a foundational layer and an instantiation layer. *Mirror* (Folio Nº I) is the foundational inquiry: it names the Mirror as a cognitive feedback loop, traces what the loop reveals and what it changes, and asks what to do in front of it. The instantiation folios respond, profession by profession: *The Multiplier and the Mirror* (Folio Nº II) gives the framework, the *Enquiry Into Specification as Meaningful Struggle* (Folio Nº III) gives the medium for software engineering, and *The Architect and the Agent* (Folio Nº IV) gives the practice for enterprise architecture.
...
Terms of art used in this paper, including FORCE, the tipping point, the substance and presentation channels, and the F→M transfer, are defined in *The Multiplier and the Mirror*. The Mirror is named foundationally in *Mirror* and formalized as a structured object in *The Multiplier and the Mirror*.
...
The interaction between the practitioner and the LLM is itself a structured object that *Mirror* (Folio Nº I) names and *The Multiplier and the Mirror* formalizes. Mirror takes articulated cognition, re-represents it, and returns it in inspectable form. It has three classes of dimensions. Reflective dimensions support the loop by which a practitioner externalizes thought, detects discrepancies between intent and reflection, updates control, and repeats: the mechanism by which deliberate engagement compounds capability. Presentation dimensions render all output with fluency, structure, and apparent confidence regardless of the substance behind it. Failure dimensions (automation-bias risk, dependency risk, coherence-hallucination risk) are properties of every interaction, not occasional defects. The substance and presentation channels of amplification are projections from Mirror: the substance projection is conditional on what the practitioner brings, the presentation projection is broadly high, and the gap between them is the structural source of epistemic risk.
...
The program publishes a numbered series. Folio Nº I, *Mirror*, is the foundational inquiry. Folios Nº II, III, and IV instantiate the program's tripartite response for specific professions: F-Star carries the framework, Spec Chat the medium, ASAP the practice. Future folios will extend the instantiation to additional professions.

### Mirror (Folio Nº I)

*Mirror* is the program's foundational inquiry. It names the Mirror as a cognitive feedback loop: a coupled system in which a practitioner's articulated cognition is reflected back, the practitioner responds to the reflection, and the iteration continues. It traces what the loop reveals about a profession's status quo, what the loop changes across cognitive, relational, institutional, and civilizational registers, and what struggle the loop makes worth undertaking. The folio sits upstream of the formal apparatus the rest of the program develops; the framework, the medium, and the practice that follow in Folios Nº II, III, and IV are the program's instantiated answers to the questions *Mirror* raises.
...
ASAP (Architect Support Agentic Platform) is the enterprise-architecture instantiation. Its concept paper, *The Architect and the Agent*, is published in three parts with citations and a worked example (Global Corp Exemplar). The paper derives the amplification architecture the framework requires across three practice structures (enterprise-embedded architect, small architecture firm, solo contract architect), names ASAP Studio as the engineering artifact through which the derivation becomes operable, and develops the operating logic the platform implements. Platform implementation is in development.

ASAP takes BTABoK as the operationalized capability taxonomy for the architect. The five competency pillars are multiplicative in the framework's sense. ASAP Studio covers four of BTABoK's working models (Engagement, Value, People, Competency), a selection from BTABoK's larger set made on amplification-architecture grounds. Only one of these, Engagement, admits reliable formalization; the others are tacit and judgment-bearing. The platform's authority is asymmetric to this formalizability: enforcement is appropriate inside the specification layer; advice and information are the strongest postures available elsewhere.

Mirror operates at two coupled scales in architecture practice. At the individual scale, the architect's reasoning is externalized to Mirror and reflected back. At the enterprise scale, architecture is itself a reflective practice: the architect's work is in part to hold a mirror to the enterprise, articulating what it is doing, where it is going, and what it is committing to. Mirror mediating the architect who mediates the enterprise produces a meta-mirror in which the enterprise is reflected to itself through two substance channels that may or may not be doing their work. A vague portfolio strategy can reflect back as a polished strategic narrative. A thin governance practice can reflect back as a comprehensive register. The enterprise then makes decisions on the strength of the flattering reflection. ASAP's amplification architecture is calibrated to this two-scale exposure.
...
The program publishes *Mirror* (Folio Nº I), the foundational inquiry that names the Mirror as a cognitive feedback loop and frames the questions the rest of the program takes up.

F-Star publishes *The Multiplier and the Mirror* (Folio Nº II) with a full appendix of equations and citations. The framework is stable. Its scope note commits to generality; its worked example is software engineering.

Spec Chat publishes *Enquiry Into Specification as Meaningful Struggle* (Folio Nº III) and releases SpecLang as a specification language for software engineering. The validator, quality analyzer, and MCP server ship. Global Corp is the substance-channel exemplar at enterprise scope. A profile extending SpecLang into enterprise-architecture objects is in development.

ASAP publishes *The Architect and the Agent* (Folio Nº IV) in three parts with citations and a worked example (Global Corp Exemplar). The amplification architecture is derived; the practice structures (enterprise-embedded architect, small architecture firm, solo contract architect) are named; ASAP Studio is named as the engineering artifact through which the derivation becomes operable. Platform implementation is in development; delivery is staged in six waves, the first four shipping as SpecChat deliverables and the last two as ASAP proper.
